            ...
            <div class="side-column">
                ...
                <div class="side-card">
                    ...
                    <div class="controls-wrapper">
                        ...
                        <button type="button" class="btn-control btn-back" onclick="window.location.href='monitoring.php'">
        ...
        async function toggleMonitoring(isStarting) {
            ...
            if (isStarting) {
                ...
                try {
                    ...
                    try {
                        await fetch('http://localhost:5000/set_elder', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({ elderID: "<?php echo $elderID; ?>" })
                        });
                    } catch (e) {
                        console.log("Could not push Elder ID to Python.");
                    }
                    ...
                    btnStart.innerHTML = '<i class="fa-solid fa-play"></i> Start Monitoring';
                    btnStart.disabled = false;
                    alert("Error starting the camera system. Please check if your camera is connected.");
