        ...
        if (!widget) {
            ...
            widget.innerHTML = `
                <div class="widget-header">
                    ...
                    <button onclick="window.location.href='active_monitoring.php'"><i class="fa-solid fa-expand"></i></button>
                </div>
    ...
    function showGlobalAlert(message, isMonitoringPage) {
        ...
        alertOverlay.innerHTML = `
            <div class="alert-box">
                ...
                ${!isMonitoringPage ? `<button onclick="window.location.href='active_monitoring.php'" style="background:white; color:#e74c3c; border:none; padding:5px 15px; border-radius:20px; font-weight:bold; cursor:pointer; margin-left:10px;">VIEW</button>` : ''}
            </div>
        `;
